...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('@egjs/component'), require('@daybrush/drag'), require('framework-utils'), require('@daybrush/utils'), require('@egjs/children-differ'), require('keycon'), require('css-styled')) :
    typeof define === 'function' && define.amd ? define(['@egjs/component', '@daybrush/drag', 'framework-utils', '@daybrush/utils', '@egjs/children-differ', 'keycon', 'css-styled'], factory) :
    (global = global || self, global.Selecto = factory(global.Component, global.Dragger, global.frameworkUtils, global.utils, global.ChildrenDiffer, global.KeyController, global.styled));
}(this, (function (Component, Dragger, frameworkUtils, utils, ChildrenDiffer, KeyController, styled) { 'use strict';
