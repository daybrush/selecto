...
(function (global, factory) {
    ...
    */
    ...
    var PROPERTIES = ["selectableTargets", "selectByClick", "selectFromInside", "continueSelect", "toggleContinueSelect", "keyContainer", "hitRate", "scrollOptions", "checkInput", "preventDefault"];
    /**
     * @memberof Selecto
     */

    var OPTIONS = __spreadArrays([// ignore target, container,
    "dragContainer"], PROPERTIES);
    var OPTION_TYPES = {
      target: null,
      container: null,
      dragContainer: null,
    ...
    function (_super) {
      ...
      function Selecto(options) {
        ...
        _this.onDragStart = function (e, clickedTarget) {
          ...
          var firstPassedTargets = _this.hitTest(hitRect, clientX, clientY, selectableTargets, selectableRects).filter(function (target) {
        ...
        _this.onDragEnd = function (e) {
          ...
          _this.selectEnd(datas.startSelectedTargets, datas.selectedTargets, getRect(e), e);
