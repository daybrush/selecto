...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('@egjs/component'), require('@daybrush/drag'), require('framework-utils'), require('@daybrush/utils'), require('@egjs/children-differ'), require('@scena/dragscroll'), require('keycon'), require('css-styled')) :
    typeof define === 'function' && define.amd ? define(['@egjs/component', '@daybrush/drag', 'framework-utils', '@daybrush/utils', '@egjs/children-differ', '@scena/dragscroll', 'keycon', 'css-styled'], factory) :
    (global = global || self, global.Selecto = factory(global.Component, global.Dragger, global.frameworkUtils, global.utils, global.ChildrenDiffer, global.DragScroll, global.KeyController, global.styled));
}(this, (function (Component, Dragger, frameworkUtils, utils, ChildrenDiffer, DragScroll, KeyController, styled) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    function (_super) {
      ...
      function Selecto(options) {
        ...
        _this.onDragStart = function (e, clickedTarget) {
          ...
          if (!selectFromInside && hasInsideTargets) {
            ...
            if (scrollOptions) {
              _this.dragScroll.dragStart(scrollOptions.container);
            }
      ...
      __proto.initElement = function () {
        ...
        this.dragContainer = this.options.dragContainer || this.target.parentNode;
